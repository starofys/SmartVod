            ...
            default:
                if (topBottomVisible) {
                    if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
                        ...
                        long position = mNiceVideoPlayer.getCurrentPosition() - 5000;
                        if (position <= 0) {
                            position = 0;
                        }
                        ...
                        long position = mNiceVideoPlayer.getCurrentPosition() + 5000;
                        if (position >= mNiceVideoPlayer.getDuration()) {
                            position = mNiceVideoPlayer.getDuration();
                        }
